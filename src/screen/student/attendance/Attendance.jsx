...
const AttendancePage = () => {
    ...
    // Fetch attendance classes on component mount
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true)
                const response = await getAttendanceClasses()
    ...
    if (loading) {
        return <div className="flex justify-center p-10">Loading classes...</div>
    }
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {currentClasses.map((cls) => (
                                <Card key={cls._id} className="border-l-4 border-l-green-500">
                                        ...
                                        {cls.attendance?.isSignedIn && !cls.attendance?.isSignedOut && (
                                            <div className="mt-4 p-3 bg-secondary/20 rounded-md">
                                                ...
                                                >
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Code will be provided by your tutor at the end of class
                                                    </p>
                                                </form>
                                            </div>
                                        )}
                                            ...
                                            <div className="mt-4 p-3 bg-green-50 rounded-md border border-green-200">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-sm text-green-800 font-medium">
                                                        Attendance completed: Signed In and Signed Out
                                                    </p>
                                                </div>
                                            </div>
                                        )}
                                ...
                                <>
                                    ...
                                    <div className="space-y-3">
                                        {upcomingClasses.map((cls) => (
                                            <Card key={cls._id} className="border-l-4 border-l-gray-300">
                                                <CardContent className="p-4">
                                                    <div className="flex justify-between items-start">
                                                        <div>
                                                            <h3 className="font-semibold">{cls.topic}</h3>
